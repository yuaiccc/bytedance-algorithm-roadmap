...
- **每天 2–3 题**，按阶段顺序走，约 **3–4 周**完整刷完一轮。
- 每道题流程：**先独立想 15 分钟 → 想不出看题解思路（别直接看代码）→ 自己写出 → 隔天默写一遍**。
- **第一优先级（字节超高频，务必默写级熟练）**：[3](https://leetcode.com/problems/longest-substring-without-repeating-characters/)、[146](https://leetcode.com/problems/lru-cache/)、[200](https://leetcode.com/problems/number-of-islands/)、[33](https://leetcode.com/problems/search-in-rotated-sorted-array/)、[42](https://leetcode.com/problems/trapping-rain-water/)、[53](https://leetcode.com/problems/maximum-subarray/)、[215](https://leetcode.com/problems/kth-largest-element-in-an-array/)、[23](https://leetcode.com/problems/merge-k-sorted-lists/)、[20](https://leetcode.com/problems/valid-parentheses/)、[206](https://leetcode.com/problems/reverse-linked-list/)、[56](https://leetcode.com/problems/merge-intervals/)、[994](https://leetcode.com/problems/rotting-oranges/)、[207](https://leetcode.com/problems/course-schedule/)、[39](https://leetcode.com/problems/combination-sum/)、[5](https://leetcode.com/problems/longest-palindromic-substring/)。
- 二刷只刷上面这条高频清单 + 当时卡壳的题即可。

---

## ⚠️ 几点提醒

1. 这份题库是第三方面经众包的，**频率和新鲜度未必准**。建议配合牛客网"字节跳动"专区的实时面经看，能看到带日期、带岗位（如"后端实习一面"）的更精确标注。
2. 字节算法面通常 **2–3 题 / 轮**，重思路清晰和边界处理，**面试时要边写边讲思路**——平时练习就养成口述习惯。
3. 真到中后期，配合 [CodeJeet](https://codejeet.com/company/bytedance) 的 System Design 板块补系统设计（社招/部分校招会考）。
